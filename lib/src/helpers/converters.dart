...
class Uint8ListConverterNullable implements JsonConverter<Uint8List?, dynamic> {
  const Uint8ListConverterNullable();
...
class Uint8ListConverter implements JsonConverter<Uint8List, dynamic> {
  ...
  @override
  Uint8List fromJson(dynamic json) => Uint8List.fromList(json as List<int>);
